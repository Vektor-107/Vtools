...
def Logo():
	run()
	subprocess.call("toilet -f standard -F gay Vektor/>",shell=True)
...
while(angka<1):
    ...
    mengetik(C+"  By: Vektor/>")
    mengetik(G+"  Team: INDONESIA FIGHTER CYBER")
    mengetik(I+"  Thanks To: AllMember Indonesia ")
